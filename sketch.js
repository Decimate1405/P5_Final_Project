...
function menuScene(){
    ...
    if(showButton){
        fill(255)
        textSize(20)
        text("Press to start the game",width/2 + 20 ,height - 180)
        let button = createButton('Start the Game');
        button.position(width/2 - 65, height - 140);
        ...
        fill(255)
        textSize(20)
        text("Select Difficulty",width/2 + 20,height - 350 )
        let button2 = createButton(difficulty);
        button2.position(width/2 - 75, height - 320);
        ...
        button3.position(width/2 - 55, height - 520);
        ...
        textSize(sizeofTitle);
        textAlign(CENTER);
        fill("red")
        text("The Last Hunter",width/2,height/2 - 280)
    }
}
...
class Enemy6{
    ...
    attack(){
        ...
        textSize(25);
        drawingContext.shadowBlur = 0;
        text("Hex",this.x + this.width/2,this.y - 10)
        fill("green");
        rect(this.x,this.y,this.width,this.height);
        this.x += this.dx;
        this.y += this.dy;
...
// The function that is going to handle all of our collision detection in level 3 is here : 
...
let enemy6 = new Enemy6(900,200,30,60,0,10)
// // The last tile : 
// tiles.push(new Tile(150,580,0,innerWidth,25,randomIntFromInterval(0,255),randomIntFromInterval(0,255),randomIntFromInterval(0,255)));
// // The second last tile : 
// tiles.push(new Tile(400,380,0,innerWidth,25,randomIntFromInterval(0,255),randomIntFromInterval(0,255),randomIntFromInterval(0,255)));
// tiles.push(new Tile(750,200,0,innerWidth,25,randomIntFromInterval(0,255),randomIntFromInterval(0,255),randomIntFromInterval(0,255)));
...
function Level3(){
    ...
    DisplayScoreandLives();
    // Calling the function for collision detection here: 
    CollisionDetection3();
...
setInterval(()=>{
    ...
    let width = randomIntFromInterval(80, 250);
    let height = 40;
    let y = randomIntFromInterval(0, 100);
    let x = randomIntFromInterval(0, innerWidth - width);
    let r = randomIntFromInterval(0,255);
    // tiles.push(new Tile(x,y,0,width,height,r,randomIntFromInterval(0,255),randomIntFromInterval(0,255)));
},2000)